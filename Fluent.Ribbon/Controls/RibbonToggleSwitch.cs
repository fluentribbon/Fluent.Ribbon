...
namespace Fluent
{
    ...
    public class RibbonToggleSwitch : System.Windows.Controls.CheckBox, IQuickAccessItemProvider, IRibbonControl
    {
        private static readonly Type controlType = typeof(RibbonToggleSwitch);

        static RibbonToggleSwitch()
        {
        ...
        protected virtual void BindQuickAccessItem(FrameworkElement element)
        {
            ...
            RibbonControl.Bind(this, element, IsCheckedProperty, BindingMode.TwoWay);
            RibbonControl.Bind(this, element, IsThreeStateProperty, BindingMode.TwoWay);
        }
