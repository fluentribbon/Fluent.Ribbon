...
namespace Fluent.Localization.Languages
{
    ...
    public class Vietnamese : RibbonLocalizationBase
    {
        ...
        public override string SwitchRibbonModeButtonScreenTipText { get; } = "Chuyển đổi giữa Dải băng đơn giản và Dải băng cổ điển.";
        public override string SwitchRibbonModeButtonScreenTipTitle { get; } = "Chuyển đổi dải băng";
