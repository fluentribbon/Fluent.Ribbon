...
namespace Fluent.Localization.Languages
{
    ...
    public class English : RibbonLocalizationBase
    {
        ...
        public override string SwitchRibbonModeButtonScreenTipText { get; } = "Switch between the Simplified Ribbon and the Classic Ribbon.";
        public override string SwitchRibbonModeButtonScreenTipTitle { get; } = "Switch Ribbons";
