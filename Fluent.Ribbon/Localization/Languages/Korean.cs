...
namespace Fluent.Localization.Languages
{
    ...
    public class Korean : RibbonLocalizationBase
    {
        ...
        public override string SwitchRibbonModeButtonScreenTipText { get; } = "간단 리본과 클래식 리본 간에 전환합니다.";
        public override string SwitchRibbonModeButtonScreenTipTitle { get; } = "리본 전환";
